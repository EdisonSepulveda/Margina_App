...
// ─────────────── Icons (small stroke set, ported from design) ───────────────
type IconProps = { size?: number }
const make = (paths: ReactNode) => ({ size = 16 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const I = {
  ...
  camp: make(<path d="M3 11l18-7-7 18-2.5-7.5L3 11z" />),
  prov: make(
    <>
  ...
  filt: make(<path d="M4 5h16l-6 8v6l-4-2v-4L4 5z" />),
  upl: make(
    <>
  ...
  dn: make(<path d="M6 9l6 6 6-6" />),
  chev: make(<path d="M9 6l6 6-6 6" />),
  back: make(<path d="M15 6l-6 6 6 6" />),
  check: make(<path d="M5 12l4 4L19 6" />),
  dot3: make(
    <>
